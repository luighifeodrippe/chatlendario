...
DECLARE
  ...
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InVlbmhiZGpqb2NkaHV0bGNjYmh1Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3MTIwMTAzNjgsImV4cCI6MjAyNzU4NjM2OH0.SzrMgaAtLU5NQ_-2fD7ZOSmQLGxY1FLETaeWlvyO1Vg'; -- full access needed for http request to storage
